    ...
    <Row style={{ marginTop: 15 }} align="middle" justify="center">
        ...
        <Col span={6}>
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: "#FFFFFF", fontSize: 13 }}>Copyright@ 2023 Created by Đỗ Tiến Thành</p>
                <p style={{ color: "#FFFFFF", fontSize: 13 }}>Điện thoại: (+84) 0342 897 002 - (+84) 0342 897 002</p>
            </div>
        </Footer>
    );
}
